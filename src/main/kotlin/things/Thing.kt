...
sealed class Thing() : Entity {
    ...
    enum class Tag(
        ...
        LEATHERVEST("leather vest", "leather vests", { LeatherVest() }),
        SCALEVEST("scale vest", "scale vests", { ScaleVest() }),
        FURJACKET("fur jacket", "fur jackets", { FurJacket() }),
        LEATHERJACKET("leather jacket", "leather jackets", { LeatherJacket() }),
        SCALEJACKET("scale jacket", "scale jackets", { ScaleJacket() }),
        JEANS("pair of jeans", "pairs of jeans", { Jeans() }),
        FURPANTS("fur pants", "pairs of fur pants", { FurPants() }),
        LEATHERPANTS("leather pants", "pairs of leather pants", { LeatherPants() }),
