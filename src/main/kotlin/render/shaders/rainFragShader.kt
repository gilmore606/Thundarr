...
fun rainFragShader() = """
    ...
    void main()
    {
        ...
        vec2 snowUV = vec2(v_UV.x + u_Time * 0.0001, v_UV.y + u_Time * u_SnowSpeed * 0.57);
        vec2 snowUV2 = vec2(v_UV.x + 0.2 + u_Time * -0.0001, v_UV.y + 0.2 + u_Time * u_SnowSpeed * 0.72);
        vec2 snowUV3 = vec2(v_UV.x + 0.46 + u_Time * 0.00004, v_UV.y + 0.46 + u_Time * u_SnowSpeed * 1.11);
        ...
        ss2.a = min(1.0, ss2.a * max(0.0, v_SnowAlpha - 0.2) / 0.4);
        ss3.a = min(1.0, ss3.a * max(0.0, v_SnowAlpha - 0.5) / 0.4);
