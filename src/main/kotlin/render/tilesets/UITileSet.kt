...
fun UITileSet() =
    TileSet(SpriteSheets.Sheet.UISprites).apply {
        ...
        setTile(Glyph.PLUS_ICON_GREEN, SimpleTile(this, 1, 3))
        setTile(Glyph.PLUS_ICON_BLUE, SimpleTile(this, 0, 5))
        ...
        setTile(Glyph.CONVERSATION_ICON, SimpleTile(this, 3, 5))
        setTile(Glyph.TRADE_ICON, SimpleTile(this, 4, 5))
