...
fun ActorTileSet() =
    TileSet(SpriteSheets.Sheet.ActorSprites).apply {
        ...
        setTile(Glyph.PEASANT_PALE_GUARD, SimpleTile(this, 7, 12))
        ...
        setTile(Glyph.PEASANT_TAN_GUARD, SimpleTile(this, 8, 12))
        ...
        setTile(Glyph.PEASANT_WHITE_GUARD, SimpleTile(this, 9, 12))
        ...
        setTile(Glyph.PEASANT_BLACK_GUARD, SimpleTile(this, 10, 12))
