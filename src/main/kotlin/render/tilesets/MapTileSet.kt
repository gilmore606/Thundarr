...
fun MapTileSet() =
    TileSet(SpriteSheets.Sheet.MapSprites).apply {
        ...
        setTile(Glyph.MAP_COLOR_0, SimpleTile(this, 8, 0))
        setTile(Glyph.MAP_COLOR_1, SimpleTile(this, 8, 1))
        setTile(Glyph.MAP_COLOR_2, SimpleTile(this, 8, 2))
        setTile(Glyph.MAP_COLOR_3, SimpleTile(this, 8, 3))
        setTile(Glyph.MAP_COLOR_4, SimpleTile(this, 8, 4))
        setTile(Glyph.MAP_COLOR_5, SimpleTile(this, 8, 5))
        setTile(Glyph.MAP_COLOR_6, SimpleTile(this, 8, 6))
        setTile(Glyph.MAP_COLOR_7, SimpleTile(this, 8, 7))
        setTile(Glyph.MAP_COLOR_8, SimpleTile(this, 9, 0))
        setTile(Glyph.MAP_COLOR_9, SimpleTile(this, 9, 1))
        setTile(Glyph.MAP_COLOR_10, SimpleTile(this, 9, 2))
        setTile(Glyph.MAP_COLOR_11, SimpleTile(this, 9, 3))
        setTile(Glyph.MAP_COLOR_12, SimpleTile(this, 9, 4))
        setTile(Glyph.MAP_COLOR_13, SimpleTile(this, 9, 5))
        setTile(Glyph.MAP_COLOR_14, SimpleTile(this, 9, 6))
        setTile(Glyph.MAP_COLOR_15, SimpleTile(this, 9, 7))
